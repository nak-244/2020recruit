...
※※2019年ゴールデンウィーク期間中の対応について※※
2019年4月27日（土）～2019年5月6日（月）の期間ですが、採用窓口は休業となります。
休業期間中にエントリーいただきました件に関しまして、5月7日（火）より順次対応させていただきます。
